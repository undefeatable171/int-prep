...
| Category | Tables |
|---|---|
| SCD Type 2 (MERGE) | patients, providers, eligibility, provider_roster |
| Upsert via MERGE | encounters, claims, lab_results, claims_adjudication |
...
Deliver a reliable, always-current view of clinical and financial operations to finance, clinical quality, and BI teams — refreshed every 4 hours, processing 45–50 GB daily — from one trusted Gold layer on Azure Databricks, with Gold tables replicated to Snowflake via ADF for org-wide consumption.
